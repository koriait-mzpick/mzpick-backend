...
public class ResponseDto {
    ...
    public static ResponseEntity<ResponseDto> noKeywordUserCount(){
        ResponseDto responseBody = new ResponseDto(ResponseCode.NO_KETWORD_USER_COUNT, ResponseMessage.NO_KETWORD_USER_COUNT);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
    }

    public static ResponseEntity<ResponseDto> noKeywordInput(){
        ResponseDto responseBody = new ResponseDto(ResponseCode.NO_KEYWORD_INPUT, ResponseMessage.NO_KEYWORD_INPUT);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
    }
